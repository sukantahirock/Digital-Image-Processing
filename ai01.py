...
temperature['cool'] = fuzz.trimf(temperature.universe, [0, 0, 30])
temperature['warm'] = fuzz.trimf(temperature.universe, [20, 30, 60])
temperature['hot'] = fuzz.trimf(temperature.universe, [50, 60, 100])

# Define humidity ranges
humidity['dry'] = fuzz.trimf(humidity.universe, [0, 0, 50])
humidity['moderate'] = fuzz.trimf(humidity.universe, [40, 50, 80])
humidity['wet'] = fuzz.trimf(humidity.universe, [70, 80, 100])

# Define fan speed ranges
fan_speed['low'] = fuzz.trimf(fan_speed.universe, [0, 0, 200])
fan_speed['moderate'] = fuzz.trimf(fan_speed.universe, [150, 200, 300])
fan_speed['high'] = fuzz.trimf(fan_speed.universe, [250, 300, 400])
